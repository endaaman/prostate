...
python train.py -m unet11b   -b 16 -e $epoch --tile $tile --dest $dest
python train.py -m unet11n   -b 16 -e $epoch --tile $tile --dest $dest
python train.py -m unet16    -b 20 -e $epoch --tile $tile --dest $dest
python train.py -m unet16b   -b 16 -e $epoch --tile $tile --dest $dest
python train.py -m unet16n   -b 16 -e $epoch --tile $tile --dest $dest
